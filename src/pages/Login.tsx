...
const Login = () => {
  ...
  const handleGuestAccess = () => {
    toast.info("Guest mode activated. You can browse but cannot place orders.");
    navigate("/dashboard");
  };
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/forgot-password" className="text-sm text-campus-blue hover:text-campus-blue-dark">
                    Forgot password?
                  </Link>
                </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-slate-600">
                ...
                <Link to="/register" className="text-campus-blue hover:text-campus-blue-dark font-medium">
                  Create Account
                </Link>
              </p>
            </div>
